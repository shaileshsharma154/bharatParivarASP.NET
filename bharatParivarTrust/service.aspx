<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="service.aspx.cs" Inherits="bharatParivarTrust.WebForm3" %>
        ...
        <div class="container">
            <div class="session-title row">
				...
				<a href="assets/images/team/membership_Form.pdf" target="_blank" title="Download Membership Form"><i class="fa fa-download"> Download Membership Form</i></a>
					...
					<marquee width="auto" direction="left" height="100px"  onmouseover="this.stop();" onmouseout="this.start();">
